...
export function BudgetCard({ budget, category, spent }: { budget: Budget; category: Category; spent: number }) {
  const percentage = Math.round((spent / budget.limit) * 100)
  const status = getBudgetStatus(percentage, budget.alertAt)
